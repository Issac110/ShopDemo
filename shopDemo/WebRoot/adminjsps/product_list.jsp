...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">商品列表</h2>
       <a href="<c:url value = '/AdminGoodServlet?method=addPre'/>" class="fr top_rt_btn add_icon">添加商品</a>
      </div>
      <section class="mtb">
       <select class="select">
        <option>下拉菜单</option>
      ...
      <table class="table">
       ...
       <c:forEach items="${goodList }" var = "good">
        ...
        <td class="center">
         ...
         <a href="<c:url value = '/AdminGoodServlet?method=editPre&gid=${good.gid }'/>" title="编辑" class="link_icon">&#101;</a>
         <a href="<c:url value = '/AdminGoodServlet?method=delete&gid=${good.gid }' />" title="删除" class="link_icon">&#100;</a>
        </td>
       </tr>
