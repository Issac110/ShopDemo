...
<script src="<c:url value = '/adminjsps/js/verificationNumbers.js'/>"></script>
<script src="<c:url value = '/adminjsps/js/Particleground.js' />"></script>
<script>
$(document).ready(function() {
  ...
  $(".submit_btn").click(function(){  
	if(validate()){
		location.href="<c:url value ='/adminjsps/main.jsp' />";
	}
	  });
});
</script>
