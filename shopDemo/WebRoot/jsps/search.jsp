	  ...
	  <ul class="paixu">
	   ...
	   <ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery-default product">
		      <li>
		        <div class="am-gallery-item">
		            <a href="detail.html" class="">
		              <img src="${pageContext.request.contextPath }/images/p.png"  alt=""/>
		      ...
		      <li>
		        <div class="am-gallery-item">
		            <a href="detail.html" class="">
		              <img src="${pageContext.request.contextPath }/images/p1.png"  alt=""/>
		      ...
		      <li>
		        <div class="am-gallery-item">
		            <a href="detail.html" class="">
		              <img src="${pageContext.request.contextPath }/images/p2.png"  alt=""/>
		      ...
		      <li>
		        <div class="am-gallery-item">
		            <a href="detail.html" class="">
		              <img src="${pageContext.request.contextPath }/images/p3.png"  alt=""/>
